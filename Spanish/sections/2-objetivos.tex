    ...
    \subsection{Específicos}
        \begin{itemize}
            \item \textbf{Sistema modular:} \\
                El sistema estará compuesto por un agente y varios \textit{plugins}, \red{los cuales deberá} ser capaz de gestionar y comunicar entre ellos, además de proveerlos con las \red{configuraciones necesarias} para que realicen funcionalidades específicas.
            ...
            \item \textbf{Sistema de planificación:} \\
                Los \textit{plugins} se ejecutarán periódicamente a través del \textit{\red{agente}}. De esta manera se controlará tanto el orden como la frecuencia de obtención y transmisión de la información.
